...
test_pos="$data_dir/CV.test.pos.fa"
test_neg="$data_dir/CV.test.neg.fa"

test_pos_pred="$predict_dir/CV.test.pos.pred.txt"
test_neg_pred="$predict_dir/CV.test.neg.pred.txt"
