...
# deltaSVM script path
deltasvm_script_path = "/home/dcakma3/projects/def-cnagy/dcakma3/mdd-scripts.v2/mdd-score_snps/deltasvm_script/deltasvm.pl"
...
for idx, _ in enumerate(job_cell_types):
    job_params.append({
        ...
        "deltasvm_script_path": deltasvm_script_path,
